...
exports.getProduct = exports.listProducts = exports.listWarehouses = exports.issueGQL = exports.getSignedRequest = exports.ModelAttributeTypes = void 0;
...
var listWarehouses = function (filter, limit, nextToken) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                statement = graphql_tag_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["query ListWarehouses($filter: ModelWarehouseFilterInput, $limit: Int, $nextToken: String) {\n        listWarehouses(filter: $filter, limit: $limit, nextToken: $nextToken) {\n          __typename\n          items {\n            __typename\n            id\n            warehouseId\n            name\n            address\n            city\n            state\n            zipcode\n            phoneNumber\n            inventory {\n              __typename\n              nextToken\n            }\n            createdAt\n            updatedAt\n          }\n          nextToken\n        }\n      }"], ["query ListWarehouses($filter: ModelWarehouseFilterInput, $limit: Int, $nextToken: String) {\n        listWarehouses(filter: $filter, limit: $limit, nextToken: $nextToken) {\n          __typename\n          items {\n            __typename\n            id\n            warehouseId\n            name\n            address\n            city\n            state\n            zipcode\n            phoneNumber\n            inventory {\n              __typename\n              nextToken\n            }\n            createdAt\n            updatedAt\n          }\n          nextToken\n        }\n      }"])));
...
var listProducts = function (filter, limit, nextToken) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                statement = graphql_tag_1.default(templateObject_2 || (templateObject_2 = __makeTemplateObject(["query ListProducts($filter: ModelProductFilterInput, $limit: Int, $nextToken: String) {\n        listProducts(filter: $filter, limit: $limit, nextToken: $nextToken) {\n          __typename\n          items {\n            __typename\n            id\n            productId\n            name\n            manufacturer\n            cost\n            price\n            inventory {\n              __typename\n              nextToken\n            }\n            createdAt\n            updatedAt\n          }\n          nextToken\n        }\n      }"], ["query ListProducts($filter: ModelProductFilterInput, $limit: Int, $nextToken: String) {\n        listProducts(filter: $filter, limit: $limit, nextToken: $nextToken) {\n          __typename\n          items {\n            __typename\n            id\n            productId\n            name\n            manufacturer\n            cost\n            price\n            inventory {\n              __typename\n              nextToken\n            }\n            createdAt\n            updatedAt\n          }\n          nextToken\n        }\n      }"])));
                gqlAPIServiceArguments = {};
                if (filter) {
                    gqlAPIServiceArguments.filter = filter;
                }
...
var getProduct = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                statement = graphql_tag_1.default(templateObject_3 || (templateObject_3 = __makeTemplateObject(["query GetProduct($id: ID!) {\n        getProduct(id: $id) {\n          __typename\n          id\n          productId\n          name\n          manufacturer\n          cost\n          price\n          inventory {\n            __typename\n            items {\n              __typename\n              id\n              warehouseId\n              productId\n              inventory\n              warehouse {\n                __typename\n                id\n                warehouseId\n                name\n                address\n                city\n                state\n                zipcode\n                phoneNumber\n                createdAt\n                updatedAt\n              }\n              createdAt\n              updatedAt\n              productInventoryId\n              warehouseInventoryId\n            }\n            nextToken\n          }\n          createdAt\n          updatedAt\n        }\n      }"], ["query GetProduct($id: ID!) {\n        getProduct(id: $id) {\n          __typename\n          id\n          productId\n          name\n          manufacturer\n          cost\n          price\n          inventory {\n            __typename\n            items {\n              __typename\n              id\n              warehouseId\n              productId\n              inventory\n              warehouse {\n                __typename\n                id\n                warehouseId\n                name\n                address\n                city\n                state\n                zipcode\n                phoneNumber\n                createdAt\n                updatedAt\n              }\n              createdAt\n              updatedAt\n              productInventoryId\n              warehouseInventoryId\n            }\n            nextToken\n          }\n          createdAt\n          updatedAt\n        }\n      }"])));
                gqlAPIServiceArguments = {
                    id: id
                };
                return [4 /*yield*/, exports.issueGQL(statement, 'GetProduct', gqlAPIServiceArguments)];
            case 1:
                data = _a.sent();
                return [2 /*return*/, data.getProduct];
        }
    });
}); };
